                ...
                for (auto entity: GetSystemEntities()) {
                    if (entity.HasTag("player")) {
                        ...
                        if (entity.HasComponent<SpriteComponent>()) {
                            ...
                            projectilePosition.x += (transform.scale.x * sprite.width / 2 - 7);
                            projectilePosition.y += ((transform.scale.y * sprite.height / 2) - 50);
                        }
                        ...
                        int directionX = 0;
                        int directionY = 0;
                        if (rigidbody.velocity.x > 0) directionY = -1;
                        if (rigidbody.velocity.x < 0) directionY = -1;
                        ...
                        projectile.AddComponent<TransformComponent>(projectilePosition, glm::vec2(0.1, 0.1), 0.0);
                        projectile.AddComponent<RigidBodyComponent>(projectileVelocity);
                        projectile.AddComponent<SpriteComponent>("bullet-image", 131, 261, 4);
                        projectile.AddComponent<BoxColliderComponent>(131 / 10, 261 / 10);
